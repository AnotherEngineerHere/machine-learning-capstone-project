...
namespace CapstoneProject.model
{
    public class Car
    {
        ...
        public Car(string brand, string sold_Price, string maintenace_Price, string number_Doors, string number_Occupants, string lug_Boot_Size, string safety_Level)
        {
            Brand = brand;
